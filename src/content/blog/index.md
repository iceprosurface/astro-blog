...
文章使用 [obsidian](https://obsidian.md/) 编写，发布使用的是 [github workflow](https://docs.github.com/en/actions/using-workflows) , 项目地址是 [https://github.com/iceprosurface/quartz-blog](https://github.com/iceprosurface/quartz-blog) 。
