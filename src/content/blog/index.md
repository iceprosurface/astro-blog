...
updated: 2026-01-24T20:24:00+08:00
tags:
  - 生活
permalink: /
ccby: false
...
文章使用 [obsidian](https://obsidian.md/) 编写，发布使用的是 [github workflow](https://docs.github.com/en/actions/using-workflows) , 项目地址是 [https://github.com/iceprosurface/astro-blog](https://github.com/iceprosurface/astro-blog) 。

归档的长文地址将会固定不变，同时旧的文章会按照相对合理的方式做 MOC 进行整理。

在本站中搜索东西在 mac 快捷键 `command+K`, win 上是 `control+K`，目前使用的是后端搜索，响应速度较快。
